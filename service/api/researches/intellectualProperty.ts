export default {
   async fetchIntellectualPropertyList(filters: { keyword: string; offset: number; max: number; recordYear: any[]; leaderId: any[]; dataTypeId: any[] }) {
   ...
   async fetchIntellectualProperty(id: number) {
      const options = {
         method: "GET",
         url: `/researches/${id}`,
      };
   ...
   async addIntellectualProperty(data: {
      datePublish: string;
      leader: Leader;
      members: Member[];
      name: string;
   ...
   async updateIntellectualProperty(data: {
      id: number;
      datePublish: string;
      leader: Leader;
      members: Member[];
   ...
   async deleteIntellectualProperty(id: number) {
      const options = {
         method: "DELETE",
         url: `/researches/${id}`,
      };
